...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "9XLXgi1zPtQgAjVboTdYOU08Y", consumerSecret: "MU5EcIPzEr9cxrMcXJe9F82AiCSFnTr0078ug8RyLO31dvRqv1")
    var loginSuccess: (() -> ())?
